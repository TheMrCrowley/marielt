  ...
  return (
    <StaticPage description={description} title={title} imageUrl={RealtorImage}>
      <Typography fontWeight="light">
        Риэлтор - это человек который отвечает за проверку документов и юридическое сопровождение
        сделки. Если вы поработаете агентом, вникните в суть работы в недвижимости, то можете стать
        риэлтором в нашей компании. Для этого вам надо будет пройти специализированные курсы и сдать
