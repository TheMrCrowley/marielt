        ...
        <div className="w-full flex justify-center items-center py-6">
          <div className={clsx('max-w-7xl', 'w-full', 'grid', 'sm:grid-cols-2', 'gap-4')}>
            ...
            <Typography fontSize={20} fontWeight="light">
              Власть над своим графиком - в ваших руках. Работа агента по недвижимости предоставляет
              уникальную свободу управления временем, что позволяет легко совмещать работу с личными
              обязанностями. Это особенно ценно для тех, кто хочет жить полной жизнью.
            </Typography>
          </div>
        </div>
        <div className="w-full flex justify-center items-center py-6">
