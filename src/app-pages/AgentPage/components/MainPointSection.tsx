  ...
  return (
    <>
      ...
      <section className={clsx('w-full', 'flex', 'flex-col', 'justify-center', 'items-center')}>
        ...
        >
          Благодаря этим преимуществам, агент по операциям с недвижимостью делает процесс покупки
          или продажи недвижимости максимально эффективным и комфортным для всех сторон.
        </Typography>
      </section>
    </>
  );
