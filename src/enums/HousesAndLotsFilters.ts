...
export const houseCharacteristicsMap: Partial<
  ...
  >
> = {
  plotSize: (value) => ({ name: 'Площадь участка', value: value as string }),
  levelNumber: (value) => ({ name: 'Число уровней', value: value as string }),
  roofMaterial: (value) => ({ name: 'Материал крыши', value: value as string }),
  wallMaterial: (value) => ({ name: 'Материал стен', value: value as string }),
  wallMaterialAdd: (value) => ({ name: 'Материал стен (доп.)', value: value as string }),
  ...
  roomsNumber: (value) => ({ name: 'Количество комнат', value: value as string }),
  heating: (value) => ({ name: 'Отопление', value: value as string }),
  gas: (value) => ({ name: 'Газ', value: value as string }),
  water: (value) => ({ name: 'Вода', value: value as string }),
  waterAdd: (value) => ({ name: 'Вода (доп.)', value: value as string }),
  sewerage: (value) => ({ name: 'Канализация', value: value as string }),
  sewerageAdd: (value) => ({ name: 'Канализация (доп.)', value: value as string }),
  electricity: (value) => ({ name: 'Электроснабжение', value: value as string }),
