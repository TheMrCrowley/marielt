      ...
      <div className={clsx('flex', 'flex-col', 'gap-10', 'max-w-7xl', 'w-full')}>
        <div className="flex flex-col gap-2 md:max-w-4xl max-w-full">
          ...
          <Typography className="md:pl-8" fontWeight="light">
            ...
            персональные сессии со штатным психологом, коучами, НЛП-мастерами за счет компании.
          </Typography>
        </div>
        <div className="flex flex-col gap-2 md:max-w-4xl max-w-full">
          <div
        ...
        <div className="flex flex-col gap-2 md:max-w-4xl max-w-full">
          ...
          <Typography className="md:pl-8" fontWeight="light">
            У нас в штате более 150 сотрудников которые любят активный отдых. Присоединяйся к
